...
Route::prefix('admin')->middleware('admin')->group(function () {
    Route::get('lessons/{lesson}/main-block/create', [\App\Http\Controllers\Admin\Course\Lesson\ContentBlockController::class, 'index'])->name('admin.course.lesson.main.create');
    ...
    Route::get('lessons/{lesson}/main-block/edit', [\App\Http\Controllers\Admin\Course\Lesson\ContentBlockController::class, 'index'])->name('admin.course.lesson.main.edit');
